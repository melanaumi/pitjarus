...
$('#btnTambahHapusJual').click(function(e){
	...
	var harga = $('input[name="harga_jual1"]').val();	
	...
	$('#body-detail').append('<tr id="row-'+i+'">'+
		...
		'<td><input type="text" class="form-control" id="harga_jual" name="harga_jual[]" value="'+harga+'"></td>'+
